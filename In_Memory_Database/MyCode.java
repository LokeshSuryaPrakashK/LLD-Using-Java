        ...
        do 
        {
            ...
            while (isDataBaseExists)
            {
                ...
                if (b == 1) {
                    ...
                    System.out.println("Do you want to create table in "+ selecteddb +"database or perform some operations on databases in user account.\n 1.Yes \t2.No");
                ...
                while (isTableExists)
                {
                    ...
                    if (c == 1) 
                    {
                        ...
                        System.out.println("Do you want to enter the values in "+tableName+" table or perform operations on tables ?\n 1.Yes \t 2.No");
                    ...
                    while(isTableDataExists)
                    {
                        ...
                        System.out.println("\nPlease choose the operation : \n 1.Add more columns and values in " + tableName+ " table \t2.Delete a column in " + tableName+ "\t3.Update the value in a column in "+tableName+"\t4.Display the data in "+tableName+" table\t5.Exit");
                    
                        int temp4 = sc.nextInt();
                        if (temp4 == 1) 
                        {
                            System.out.print("Enter number of records in "+tableName+" : ");
                            int noOfColumns = sc.nextInt();
                            for(int i=0;i<noOfColumns;i++)
                            {
                                System.out.print("Enter column name : ");
